...
Источник правил:
- `docs/CONTRACTS_OVERVIEW.md`
- `docs/ARTIFACTS_AND_SCHEMAS.md`
- `docs/SEGMENTER_CONTRACT.md`
- `docs/ORCHESTRATION_AND_CACHING.md`
- `docs/ML_TARGETS_AND_TRAINING.md`
- `docs/LLM_RENDERING.md`
...
Для каждого NPZ обеспечить обязательные meta-поля (см. `docs/ARTIFACTS_AND_SCHEMAS.md`).
