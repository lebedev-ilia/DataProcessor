...
Средняя скорость движения по кадрам, вычисляемая как среднее значение величин оптического потока Farneback между соседними кадрами (после лёгкого сглаживания). Отражает общую интенсивность движения в видео.
...
Частота резких изменений направления движения в секунду: доля кадров, где изменение среднего угла оптического потока между соседними кадрами превышает порог (например, 45°), делённая на длительность видео. Отражает хаотичность / "дёрганость" движения.
